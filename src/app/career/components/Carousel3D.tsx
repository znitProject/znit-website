      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: "400px",
            background:
              "radial-gradient(circle, transparent 0%, rgba(0,0,0,0.05) 30%, rgba(0,0,0,0.1) 60%, transparent 100%)",
            left: "50%",
            top: "50%",
        ...
        <div
          ...
          style={{
            ...
            height: "300px",
            background:
              "radial-gradient(circle, transparent 0%, rgba(0,0,0,0.1) 30%, rgba(0,0,0,0.2) 60%, transparent 100%)",
            left: "50%",
            top: "50%",
            transform: "translate(-50%, -50%)",
            filter: "blur(2px)",
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, #000000 0%, #000000 60%, rgba(0,0,0,0.8) 100%)",
              boxShadow: `
