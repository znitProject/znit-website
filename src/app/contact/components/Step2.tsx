...
export default function Step2({ formData, updateFormData }: Step2Props) {
  ...
  return (
    <div className="py-8">
      <h2 className="text-4xl font-bold text-gray-900 mb-12">프로젝트에 대해 자세히 알려줘</h2>
      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-end items-center space-x-4">
          {selectedFile && (
            <div className="flex items-center space-x-3 px-4 py-2 border-2 border-gray-900 rounded-lg">
