...
const WorkWithUsCard = () => {
  ...
  return (
    <Link
      ...
      className="relative inline-block overflow-hidden px-8 py-6 rounded-xl bg-[#F5F5F5] cursor-pointer transform transition-transform duration-300 min-h-[120px] flex items-center justify-center"
    >
      {/* 파도 모양 그라디언트 배경 */}
      <div
        ref={bgRef}
