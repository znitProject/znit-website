...
const HomeTitleSection: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center xl:items-start">
      ...
      <h1
        className="font-extrabold text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl leading-[0.9] sm:leading-[0.95] text-black whitespace-pre-line mb-4 sm:mb-6 md:mb-8 text-center xl:text-left max-w-full px-2 sm:px-0"
        style={{
      ...
      >
        ...
        <span
          ref={cursorRef}
          className="inline-block w-[0.08em] h-[0.85em] bg-black ml-2 align-baseline relative -top-[2px]"
        ></span>
      </h1>
    </div>
  );
