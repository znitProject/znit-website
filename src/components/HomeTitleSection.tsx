...
const HomeTitleSection: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center xl:items-start">
      ...
      <h1
        className={`font-extrabold text-2xl xs:text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-8xl leading-[0.9] sm:leading-[0.95] ${textColorClass} whitespace-pre-line mb-4 sm:mb-6 md:mb-8 text-center xl:text-left max-w-full px-2 sm:px-0 transition-colors duration-300`}
        style={{
