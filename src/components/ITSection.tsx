...
export default function ITSection() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-[800px] top-[230px] z-10 max-w-none ${isVisible ? "description-first" : ""}`}
      >
      ...
      <div
        className={`absolute left-[900px] top-[460px] z-10 max-w-none ${isVisible ? "description-second" : ""}`}
      >
        <p className="text-gray-700 leading-relaxed">
      ...
      <div
        className={`absolute left-[800px] top-[680px] z-10 max-w-none ${isVisible ? "description-third" : ""}`}
      >
        <p className="text-gray-700 leading-relaxed">
